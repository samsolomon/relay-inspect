...
export function buildOverlayScript(port: number): string {
  ...
  styleEl.textContent = [
    ...
    '  border: 3px solid #7C3AED; border-radius: 10px; z-index: 999998; pointer-events: none;',
    ...
    '  height: 32px; padding: 0 14px; border-radius: 16px; border: 1px solid var(--relay-border);',
