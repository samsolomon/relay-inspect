...
export function buildOverlayScript(port: number): string {
  ...
  styleEl.textContent = [
    // --- Design tokens ---
    '.relay-annotate-root { --relay-radius-sm: 4px; --relay-radius-lg: 8px; }',
    // --- Theme variables ---
    ...
    '  padding: 4px 8px; border-radius: var(--relay-radius-sm);',
    ...
    '  padding: 1px 4px; border-radius: var(--relay-radius-sm);',
    ...
    '  outline: 2px dashed #7C3AED; outline-offset: -1px; border-radius: var(--relay-radius-sm); background: rgba(124, 58, 237, 0.08);',
    ...
    '  border-radius: var(--relay-radius-sm); margin: 0 0 12px;',
    ...
    '  flex-shrink: 0; width: 28px; height: 28px; padding: 0; border-radius: var(--relay-radius-sm);',
